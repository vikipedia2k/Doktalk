        ...
        <div class="row about-column">
            ...
            <div class="col-md-6 content-column">
                <div class="heading-block">
                    <h4 class="heading font-bold">Psychologist Consultation</h4>
                </div> 
                <h5 class="about-head">About</h5>
               <p class="about-text">Psychologists are medical experts specializing in mental health, and who can prescribe medication when needed.
                </p>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 physicians-head">
                    <h4 class="heading font-bold">Available Psychologists</h4>
            </div>
        </div>
            ...
            <div class="row card-content">
                ...
                <div class="col-md-4 doc-info">
                    <div class="card-body">
                        ...
                        <p class="card-text"> 
                                <span style="font-weight:500; font-size:16px;">Psychologist</span></p>
                        <p class="card-text"> MA - Psychology, BHMS </p>
