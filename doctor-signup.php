...
<body>
            ...
            <div class="container">
                <div class="doktalk col-3">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <form method="POST" action="assets/doctor-signup.php" class="register-form" id="register-form">
                                  ...
                                  <div class="col-6 login-link"> 
                                    <a href="assets/doctor-login.php" class="login-link">Already have an account?</a>                  
                                  </div> 
